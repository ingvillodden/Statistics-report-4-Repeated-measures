...
## Introduction
What is the recommended intensity for strength development, low- or high-repetition training? Anderson & Kearney [-@Anderson1982] conducted a study on male college students, and found that after a 9 weeks training intervention, 3x6-8 repetition maximum (RM) training, gave a greater increase in 1 RM benchpress compared to 2x30-40 RM training (20 % and 8 %, respectively). However, Stone & Coulter [-@Stone1994] who conducted a similar 9 weeks training intervention on female collage students, found that both 3x6-8 RM and 1x30-40 RM gave significant pre to post increases in 1 RM in both upper and lower body exercises. They could not find a significant difference between the groups after the intervention. These results suggests that both low- and high-repetition training improves strength measured as 1 RM, and to find out if one of them is superior to the other and thus should be recommended, more studies are required

In this study we wanted to compare the effects of 10 and 30 RM training. The participants were assigned to one of two groups, training with either 10 RM or 30 RM. Strength was tested as 1 RM legpress and benchpress before (pre), during (mid) and after (post) the training intervention. 27 participants completed the first two tests, and 24 participants completed all three tests.
...
This study therefore suggests that 10 RM training gives a larger development of strength measured as 1 RM in legpress, compared to 30 RM training. In other words, the findings suggests that 10 RM should be the recommended intensity for strength development.
